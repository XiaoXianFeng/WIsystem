...
<table class="oms_table" style="margin-left: auto; margin-right: auto; border: 0px">
	...
	<tr>
		...
		<td style="width:200px">
			<a href="#" class="editable" id="fileNo" data-placement="bottom" data-type="textarea" data-pk="fileNo" data-url="${(rc.getContextPath())!}/do/plan/save.html" data-title="输入工单编号/(订单编号)">${(plan.planItems['fileNo'].itemValue)!}</a>
		</td>
